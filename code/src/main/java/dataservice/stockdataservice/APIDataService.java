...
public interface APIDataService {
     ...
     */
    StockPO getStock(String name, String start, String end, String fields) throws IOException, NotFoundException;
     ...
     * @return 指定大盘指数的数据
     */
    StockPO getBenchmark(String bench, String start, String end, String fields) throws IOException, NotFoundException;
