...
public class RefreshCacheThread extends Thread {
    ...
    private void getSelectedStocks() throws IOException {
        ...
        ArrayList<String> selectedStocks = FileIOHelper.readTxtFileLines(FilePath.CACHE_DIR +"selectedStocks.txt");
    ...
    public void refreshStock() throws IOException {
        ...
        FileIOHelper.creatTxtFile(namesAndStocks, FilePath.CACHE_DIR +"cacheStockInfo.txt");
