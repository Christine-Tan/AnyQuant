...
public class TradeInfoLine {
    ...
    public TradeInfoLine(TradeDao dao){
        ...
        this.price = Double.parseDouble(dao.getPrice());
        this.change = Double.parseDouble(dao.getChange());
        this.volume = Double.parseDouble(dao.getVolume());
        this.amount = Double.parseDouble(dao.getAmount());
